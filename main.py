"""
Japanese Proverb Generator - A Python program that generates random Japanese proverbs
using OpenAI, Anthropic Claude, Google Gemini, or LMstudio (local model).
"""
import os
